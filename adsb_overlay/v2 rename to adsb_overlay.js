    ...
    async function fetchPlanes() {
        try {
            ...
            for (const plane of data.aircraft) {
                ...
                const labelText = plane.flight || icao;

                // small inline-styled label
                const labelHTML = `
                    <span style="
                        font-size:10px;
                        font-weight:600;
                ...
                const info = `
                   <b> Flight: <a href="https://www.flightaware.com/live/flight/${labelText}" target="_blank">
                        ${labelText}
                    </a></b><br>
                ...
                if (markers[icao]) {
                    ...
                    markers[icao].setTooltipContent(labelHTML);
